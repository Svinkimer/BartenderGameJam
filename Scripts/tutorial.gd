...
func create_bar_menu():
	...
	bar_menu += "[cell][indent][indent]• Силушка\nбогатырская\n• 50 abCent\n[/indent][/indent][/cell][/table]\n\n"
	
	# Cocktails 3 & 4
	bar_menu += "[table=4][cell][center][b]Копуляция\nна Татуине[/b][/center][/cell][cell][/cell]"
	...
	bar_menu += "[cell][indent][indent]• Кровь\nОМЕЖки\n• Жижа\n[/indent][/indent][/cell][/table]\n\n"
	...
	bar_menu += "[font_size=10]Make sure to pay your taxes by pressing 'N' before serving your every 5th customer.[/font_size]\n"
